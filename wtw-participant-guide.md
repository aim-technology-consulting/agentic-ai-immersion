...
Great meeting you all this week — as promised, here is the pre-read for the April session.

All we need from you before the day is to pick **5 use cases you want to work through hands-on**. Browse the 7 technology areas below — each one has a short description and a list of specific use cases underneath it — and let us know which 5 you want to dig into.

Your picks shape the whole day. We use them to group people, decide which use cases get the most airtime, and make sure the session reflects what actually matters to your team rather than a generic agenda.

**Please send your 5 choices to [facilitator contact] by [date].** Instructions for responding are at the end of this document.
...
- If you're new to this space, include at least one use case from **Conversational AI Agents** — it's the foundation everything else builds on.
